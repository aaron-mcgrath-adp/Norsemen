...
public class MapCreatorMain  extends Application {
  @Override
  public void start(Stage primaryStage) {
    try {
      FXMLLoader loader = new FXMLLoader(getClass().getResource("/MapCreator.fxml"));
      loader.setController(new MapCreatorController());
